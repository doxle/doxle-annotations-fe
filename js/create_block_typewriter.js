(function() {
  function init() {
    var el = document.getElementById('create-block-input');
    if (!el) return;
    ...
    var INLINE_CURSOR = '<span class="cb-inline-cursor">_</span>';
    var idleCursor = null;
    var liveCursor = null;

    el.innerHTML = '';
    el.classList.add('cb-placeholder');
    el.focus();
    ...
    function ensureIdleCursor() {
      ...
      idleCursor.className = 'cb-idle-cursor';
    ...
    function ensureLiveCursor() {
      ...
      liveCursor.className = 'cb-live-cursor';
    ...
    function clearPlaceholder() {
      ...
      isAnimatingPlaceholder = false;
      el.innerHTML = '';
      el.classList.remove('cb-placeholder');
    ...
    el.addEventListener('keydown', function(e) {
      if (e.key === 'Enter') {
        ...
        el.dispatchEvent(new CustomEvent('blocksubmit', { detail: text, bubbles: true }));
        return;
      }
  ...
  function tryInit() {
    if (document.getElementById('create-block-input')) init();
