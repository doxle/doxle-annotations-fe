...
use crate::core::progress::show_success;
...
pub fn AppNavbar(
    ...
    let is_create_project_page = matches!(&route, Route::CreateProjectPage {});
        ...
        nav{
            class:"app-navbar",
             ...
             div {
                ...
                // Projects breadcrumb on create project page
                if is_create_project_page {
                    div {
                        class: "app-breadcrumb-item clickable",
                        onclick: move |_| {
                            nav.push(Route::ProjectsPage {});
                    ...
                    div { class: "app-breadcrumb-item current", "New Project" }
                }
                ...
                if let Some(name) = &block_name {
                    {
                        let decoded_name = crate::core::route_utils::decode_route_segment(name);
                        rsx! {
                            if has_project_context {
                                span {
                                    class: "app-breadcrumb-chevron",
                ...
                if let Some(img_name) = &image_name {
                    {
                        let decoded_image_name = crate::core::route_utils::decode_route_segment(img_name);
                        rsx! {
                            span {
                                class: "app-breadcrumb-chevron",
                                "/"
                            ...
                            span { 
                                ...
                                "data-tooltip" : "{decoded_image_name}",
                                 span {
