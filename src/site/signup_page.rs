...
pub fn SignupPage() -> Element {
    ...
    let handle_submit = move |evt: Event<FormData>| {
        ...
        spawn(async move {
            ...
            match auth_api::signup(&email_value, &password_value, &invite_code_value).await {
                Ok(signup_resp) => {
                    ...
                    let user_role = match signup_resp.role.as_deref() {
                        Some("builder") => users_api::UserRole::Builder,
                        Some("admin") => users_api::UserRole::Admin,
                        _ => users_api::UserRole::Annotator,
                    };
                    ...
                    match auth_api::authenticate(&email_value, &password_value).await {
                        Ok(_auth_result) => {
                            ...
                            match users_api::create_user_profile(
                                name_value,
                                email_value,
