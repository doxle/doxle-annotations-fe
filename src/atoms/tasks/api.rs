...
pub async fn api_list_task_images(project_id: &str, block_id: &str, task_id: &str) -> Result<Vec<crate::atoms::media::Image>, String> {
    let endpoint = format!("/projects/{}/blocks/{}/tasks/{}/images", project_id, block_id, task_id);
    client::get::<Vec<crate::atoms::media::Image>>(&endpoint).await
}
