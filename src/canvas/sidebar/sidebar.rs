...
#[component]
pub fn Sidebar(task_id: String, project_id: String, sidebar_open: Signal<bool>, classes_version: Signal<u64>) -> Element {
...
let up_cb = {
    ...
    rsx! {
        div {
            ...
            // Content
            match active_tab() {
                SidebarTab::Classes => rsx! { ClassesPanel { project_id: project_id.clone(), classes_version: classes_version } },
