...
const DELETE_ICON_LIGHT: Asset = asset!("/assets/icons/delete-light-task-menu.svg");
const DELETE_ICON_DARK: Asset = asset!("/assets/icons/delete-dark-task-menu.svg");
const EDIT_ICON_LIGHT: Asset = asset!("/assets/icons/edit-light-task-menu.svg");
const EDIT_ICON_DARK: Asset = asset!("/assets/icons/edit-dark-task-menu.svg");
const ARCHIVE_ICON_LIGHT: Asset = asset!("/assets/icons/archive-light-task-menu.svg");
const ARCHIVE_ICON_DARK: Asset = asset!("/assets/icons/archive-dark-task-menu.svg");
