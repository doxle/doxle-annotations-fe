...
const EDIT_BLOCK_MODAL_CSS: &str = r#"
.edit-modal-overlay {
    position: fixed;
    inset: 0;
    ...
    rsx! {
        ...
        div {
            ...
            div {
                ...
                h2 { class: "edit-modal-title", "Edit Block Name" }
                input {
                ...
                div {
                    ...
                    button {
                        class: "edit-modal-btn edit-modal-btn-save",
                        disabled: !is_valid,
                        onclick: move |_| {
                            if is_valid {
                                on_save.call(name().trim().to_string());
